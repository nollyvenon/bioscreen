<?php
	...
	if(isset($_POST['delete_lab_scientist']) && $_POST['delete_lab_scientist'] != '') { 
		$message = $labscientist->delete_lab_scientist($_POST['delete_lab_scientist']);
	}//delete account.
	
	$new_store->set_store($_SESSION['store_id']); //setting store.
	 
	$page_title = 'Lab Scientist'; //You can edit this to change your page title.
	...
	<!--content here-->
    <p>
	    <a href="manage_lab_scientist.php" class="btn btn-primary btn-default">Add New</a>
    </p>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table-responsive table-hover table display table-bordered" id="wc_table" width="100%">
        ...
        <tbody>
			<?php $labscientist->list_laboratorist(); ?>
        </tbody>
    </table> 
    <!--content Ends here.-->
