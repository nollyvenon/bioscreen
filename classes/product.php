...
class Product {
	...
	function add_product($product_manual_id, $product_name, $product_unit, $category_id, $product_expiry_date, $tax_id, $product_cost, $product_selling_price, $alert_units, $product_image, $product_description) { 
		global $db;
		...
		if($num_rows > 0) { 
			...
			$query = "INSERT into products (product_id, product_manual_id, product_name, product_description, product_unit, category_id, product_expiry_date, tax_id, product_image, alert_units, store_id) VALUES(NULL, '".$product_manual_id."', '".$product_name."', '".$product_description."', '".$product_unit."', '".$category_id."', '".$product_expiry_date."', '".$tax_id."', '".$product_image."', '".$alert_units."', '".$_SESSION['store_id']."')";
			$result = $db->query($query) or die($db->error);
	...
	function update_product($edit_product,$product_manual_id, $product_name, $product_unit, $category_id, $product_expiry_date, $tax_id, $product_cost, $product_selling_price, $alert_units, $product_image, $product_description) {
		global $db;
