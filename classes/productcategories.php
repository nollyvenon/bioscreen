...
class ProductCategory {
	...
	function add_category($category_name, $category_description) { 
		...
		if($num_rows > 0) { 
			...
			$query = "INSERT into product_categories(category_id,category_name,category_description,store_id) VALUES(NULL, '".$category_name."', '".$category_description."', '".$_SESSION['store_id']."')";
			$result = $db->query($query) or die($db->error);
