                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <strong>Access To: </strong>
                                    ...
                                    <input type="checkbox" name="access_to[]" value="clients" /> Patients &nbsp;
                                    ...
                                    <input type="checkbox" name="access_to[]" value="labsamples" /> Lab Samples
                                    <input type="checkbox" name="access_to[]" value="lab_scientists" /> Lab Scientists
                                </td>
                            </tr>
                            <tr>
